...
$results  = "SLX-"."$ARGV[1]".".FLD0"."$ARGV[0]".".000000000-"."$ARGV[2]".".s_1.r_2.trim.fq";
open(OUTPUT, ">>$results");
...
open (INPUT, "SLX-"."$ARGV[1]".".FLD0"."$ARGV[0]".".000000000-"."$ARGV[2]".".s_1.r_2.fq") or die "\nInput file could not be found\n\n";
$line = 1;
$trimmed = 0;
$length = 150;
